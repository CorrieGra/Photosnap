    ...
    <div className="footer container">
      <div className="footer__details">
        <div className="footer__logo">
          <svg id="logo" xmlns="http://www.w3.org/2000/svg" width="170" height="16" >
            <defs>
        ...
        <div className="footer__socials">
            <ul className="footer__socials--menu">
                <li className="footer__socials--menu-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                        <defs>
                            <linearGradient id="b" x1="100%" x2="0%" y1="0%" y2="100%">
                                <stop offset="0%" stopColor="#6028F1"/>
                                <stop offset="100%" stopColor="#63AFDB"/>
                            </linearGradient>
                        </defs>
                        <path className="icon" fill="url(#b)" d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z"/>
                    </svg>
                </li>
                <li className="footer__socials--menu-item">
      ...
      <div className="footer__navigation">
        <ul className="footer__navigation--menu">
          <li className="footer__navigation--menu-item t-upper">
              <Link to="/">home</Link>
          </li>
          <li className="footer__navigation--menu-item t-upper">
      ...
      <div className="footer__actions">
        <div className="footer__actions--cta">
            <SecondaryButton text="get an invite" theme="dark" />
        </div>
        <div className="footer__actions--copyright">
            <p style={{ color: 'rgb(233, 233, 233)' }}>Copyright 2021 &copy; - All Rights Reserved</p>
        </div>
      </div>
    </div>
    </footer>
